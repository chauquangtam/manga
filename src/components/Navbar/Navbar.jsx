    ...
    return (
        <nav className="flex items-center">
            <div className="flex items-center ">
                <div className="text-20 font-bold mr-2">NerCard</div>
                {isDarkMode ?(
                <BsSunFill size={"24px"} color="#e9c45a" className="cursor-pointer" onClick={()=>toggleDarkMode(!isDarkMode)} />
                ):(
                    <FaMoon size={"24px"} color="#e9c45a" className="cursor-pointer" onClick={()=>toggleDarkMode(!isDarkMode)} />
                )
            }
            </div>
            <ul className="md:flex md:gap-10 ml-auto text-16 font-semibold">
                ...
                <>
                    ...
                    <li className="btn-hover">Out Story</li>
                    <li className="btn-hover">Contacts</li>
                </>
                )}
                {openMenu && (
